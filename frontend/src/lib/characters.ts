...
// 콘텐츠 타입에 맞는 캐릭터 추천
export function getRecommendedCharacters(contentType: string): Character[] {
...
// 비디오 프롬프트 생성
export function generateVideoPrompt(character: Character, narration: string, action?: string): string {
