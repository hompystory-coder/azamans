    ...
    <div class="container">
        ...
        <form id="testForm" method="post" action="">
            <div style="margin-bottom: 20px;">
                ...
                <textarea id="content" name="content" style="width: 100%; height: 150px; padding: 10px; border: 1px solid #ddd; border-radius: 5px;">
<h2>CKEditor 5 테스트 페이지입니다!</h2>
...
&lt;?php include '/home/mvc/editor.php'; ?&gt;
