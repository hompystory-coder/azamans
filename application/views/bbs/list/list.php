        ...
        <div class="card border-0 shadow-sm mb-4 animate__animated animate__fadeIn">
            <div class="card-body">
                <form method="get" action="/bbs/<?php echo $board['bbs_id']; ?>" class="row g-3">
                    <?php if (!empty($board['bbs_category'])): ?>
                        <div class="col-md-3">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <?php if (!empty($posts)): ?>
                            <?php 
                            $num = $total - (($current_page - 1) * ($board['page_rows'] ?? 20));
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="<?php echo !empty($board['bbs_category']) ? 6 : 5; ?>" class="text-center py-5 text-muted">
