...
<head>
    ...
    <title><?php echo xssFilter($post['title']); ?> - <?php echo xssFilter($board['bbs_name']); ?></title>
...
<body>
    ...
    <main class="container board-container">
        <div class="board-header">
            <h1><?php echo xssFilter($board['bbs_name']); ?></h1>
        </div>
        ...
        <article class="post-view">
            ...
            <div class="post-footer">
                <div class="post-actions">
                    <a href="/bbs/<?php echo $board['bbs_id']; ?>" class="btn">목록</a>
    ...
    function deletePost() {
        ...
        fetch('/bbs/<?php echo $board['bbs_id']; ?>/delete/<?php echo $post['uid']; ?>', {
            method: 'POST',
    ...
    function deleteComment(commentId) {
        ...
        fetch('/bbs/<?php echo $board['bbs_id']; ?>/comment/<?php echo $post['uid']; ?>/' + commentId, {
            method: 'DELETE',
            headers: {'Content-Type': 'application/json'}
        })
        .then(res => res.json())
