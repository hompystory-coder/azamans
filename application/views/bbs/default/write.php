...
<head>
    ...
    <title><?php echo $mode === 'write' ? '글쓰기' : '글수정'; ?> - <?php echo xssFilter($board['board_name']); ?></title>
...
<body>
    ...
    <main class="container board-container">
        <div class="board-header">
            ...
            <p class="board-desc"><?php echo xssFilter($board['board_name']); ?></p>
        </div>
        ...
        <form id="writeForm" class="write-form" onsubmit="submitPost(event)">
            ...
            <div class="form-group">
                ...
                <input type="text" name="subject" id="subject" 
                       value="<?php echo isset($post) ? xssFilter($post['subject']) : ''; ?>" 
            ...
            <div class="form-group form-checkbox">
                <label>
                    <input type="checkbox" name="use_secret" value="Y" 
            ...
            <div class="write-form-footer">
                <a href="/bbs/<?php echo $board['board_id']; ?>" class="btn">취소</a>
    ...
    function submitPost(e) {
        ...
        const url = <?php echo $mode === 'write' 
            ? "'/bbs/{$board['board_id']}/write-process'" 
            : "'/bbs/{$board['board_id']}/edit-process/{$post['uid']}'"; ?>;
