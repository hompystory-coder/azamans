            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <?php if (!empty($posts)): ?>
                            <?php 
                            $num = $total - (($current_page - 1) * $news['posts_per_page']);
                ...
                <div class="card-body border-top">
                    ...
                    <div class="text-center text-muted mt-3">
                        <small>
                            ...
                            <?php echo number_format(($current_page - 1) * $news['posts_per_page'] + 1); ?> - 
                            <?php echo number_format(min($current_page * $news['posts_per_page'], $total)); ?>개 표시
                        </small>
                    </div>
                </div>
            <?php endif; ?>
