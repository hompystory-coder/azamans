        ...
        <div class="card border-0 shadow-sm mb-4 animate__animated animate__fadeInUp">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                    <div>
                        <a href="/news/<?php echo $news['news_id']; ?>" class="btn btn-outline-secondary">
                            <i class="fas fa-list me-1"></i>목록
                        </a>
                        <?php if (isLoggedIn() && ((isset($_SESSION['user_id']) && $post['member_uid'] == $_SESSION['user_id']) || isAdmin())): ?>
                            <a href="/news/<?php echo $news['news_id']; ?>/edit/<?php echo $post['uid']; ?>" class="btn btn-outline-primary">
                                <i class="fas fa-edit me-1"></i>수정
                            </a>
                            <button onclick="deletePost('<?php echo $news['news_id']; ?>', <?php echo $post['uid']; ?>)" class="btn btn-outline-danger">
