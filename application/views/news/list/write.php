...
<head>
    ...
    <title><?php echo $mode === 'write' ? '글쓰기' : '글수정'; ?> - <?php echo xssFilter($news['news_name']); ?></title>
    <link rel="stylesheet" href="/public/css/style.css">
    <link rel="stylesheet" href="/public/css/board.css">
    <link rel="stylesheet" href="/public/css/news_common.css">
    <script src="/public/js/news_write.js"></script>
    <style>
        .existing-files {
            display: flex;
...
<body>
    ...
    <main class="container board-container">
        <div class="board-header">
            ...
            <p class="board-desc"><?php echo xssFilter($news['news_name']); ?></p>
        </div>
        ...
        <form id="writeForm" class="write-form" 
              ...
              data-action-url="<?php echo $mode === 'write' 
                  ? '/news/' . $news['news_id'] . '/write-process' 
                  : '/news/' . $news['news_id'] . '/edit-process/' . $post['uid']; ?>">
            <?php if (!empty($news['news_category']) && !empty($news['news_category'])): ?>
            ...
            <div class="write-form-footer">
                <a href="/news/<?php echo $news['news_id']; ?>" class="btn">취소</a>
    ...
    initCKEditor('content', [
        'imageUploadUrl' => '/upload/news/image',
        'height' => 500
    ]);
    ?>
</body>
