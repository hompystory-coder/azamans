                    ...
                    <div class="col-md-3">
                        <select name="board_id" class="form-select">
                            ...
                            <option value="<?php echo $board['board_id']; ?>" 
                                    <?php echo ($board_id == $board['board_id']) ? 'selected' : ''; ?>>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="7" class="text-center py-5 text-muted">게시물이 없습니다.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                ...
                <nav>
                    <ul class="pagination justify-content-center mb-0">
                        ...
                        <li class="page-item <?php echo ($i == $current_page) ? 'active' : ''; ?>">
                            <a class="page-link" href="?page=<?php echo $i; ?>&board_id=<?php echo $board_id; ?>&search=<?php echo urlencode($search); ?>">
                                <?php echo $i; ?>
                            </a>
                        </li>
                        <?php endfor; ?>
