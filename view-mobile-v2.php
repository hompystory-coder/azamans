   ...
   <div class="w_article">
         ...
         <!--// 댓글영역-->
			 ...
			 //echo "view-mobile.php";
	          ...
	          $coupang_var_file = $g['path_var'].'site/'.$r.'/'.$r.'_news_coupang.var.php'; if(is_file($coupang_var_file)) include_once $coupang_var_file;
	          ...
	          if($coupang_store_tag && $coupang_partners_id && $coupang_store_access_key && $coupang_store_secret_key) { //http://www.renewtimes.com/
                ...
                $coupang_product_file = $fserverurl.$r.'_coupang_product.php'; if(is_file($coupang_product_file)) include_once $coupang_product_file;				
